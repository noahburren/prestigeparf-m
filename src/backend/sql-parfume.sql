...
INSERT INTO Perfume (perfume_name, brand_id)
VALUES (
...
VALUES ('La Vie Est Belle', 10),
    ...
    (
        'La Vie Est Belle L Extrait de Parfum by Mellerio dits Meller',
        10
    ),
...
VALUES (1, 1),
    -- Acqua di Parma Blu Mediterraneo Arancia di Capri, accord_id für "citrus"
    (1, 2),
    -- accord_id für "fresh spicy"
    (2, 3),
    -- Acqua di Parma Blu Mediterraneo Cipresso di Toscana, accord_id für "aromatic"
    (2, 4),
    -- accord_id für "woody"
    (3, 1),
    -- Acqua di Parma Blu Mediterraneo Fico di Amalfi, accord_id für "fruity"
    (4, 2),
    -- Acqua di Parma Blu Mediterraneo Ginepro di Sardegna, accord_id für "fresh spicy"
    (5, 3),
    -- Acqua di Parma Blu Mediterraneo Mandorlo di Sicilia, accord_id für "almond"
    (6, 1),
    -- Acqua di Parma Blu Mediterraneo Bergamotto di Calabria, accord_id für "citrus"
    (7, 3);
-- Acqua di Parma Blu Mediterraneo Mirto di Panarea, accord_id für "aromatic"
-- Insert into Perfume_Notes for each perfume
INSERT INTO Perfume_Notes (perfume_id, note_id)
VALUES (1, 1),
    -- Acqua di Parma Blu Mediterraneo Arancia di Capri, note_id für "Petitgrain"
    (1, 2),
    -- note_id für "Cardamom"
    (1, 3),
    -- note_id für "Musk"
    (1, 4),
    -- note_id für "Caramel"
    ...
    -- note_id für "Orange"
    (1, 6),
    -- note_id für "Sicilian Mandarin"
    (1, 7),
    -- note_id für "Bergamot"
    (1, 8),
    -- note_id für "Lemon"
    (2, 9),
    -- Acqua di Parma Blu Mediterraneo Cipresso di Toscana, note_id für "Pine Tree"
    (2, 10),
    -- note_id für "Coriander"
    (2, 11),
    -- note_id für "Lavender"
    (2, 12),
    -- note_id für "Jasmine"
    (2, 13),
    -- note_id für "Lily-of-the-Valley"
    (3, 1),
    -- Acqua di Parma Blu Mediterraneo Fico di Amalfi, note_id für "Petitgrain"
    (3, 2),
    -- note_id für "Cardamom"
    (3, 14),
    -- note_id für "Cedar"
    (3, 15),
    -- note_id für "Fig Tree"
    (3, 16),
    -- note_id für "Benzoin"
    (4, 17),
    -- Acqua di Parma Blu Mediterraneo Ginepro di Sardegna, note_id für "Sage"
    (4, 18),
    -- note_id für "Cypress"
    (5, 19),
    -- Acqua di Parma Blu Mediterraneo Mandorlo di Sicilia, note_id für "Jasmine"
    (5, 20),
    -- note_id für "White Peach"
    (5, 21),
    -- note_id für "Ylang-Ylang"
    (5, 22),
    -- note_id für "Bourbon Vanilla"
    (6, 1),
    -- Acqua di Parma Blu Mediterraneo Bergamotto di Calabria, note_id für "Petitgrain"
    (6, 2),
    -- note_id für "Cardamom"
    (6, 23),
    -- note_id für "Ginger"
    ...
    -- note_id für "Cedar"
    (7, 25),
    -- Acqua di Parma Blu Mediterraneo Mirto di Panarea, note_id für "Sea Notes"
    (7, 26),
    -- note_id für "Jasmine"
    (7, 27);
-- note_id für "Rose"
...
VALUES (8, 3),
    ...
    (14, 13),
    (14, 11),
    -- Burberry Summer for Women 2010
    (15, 7),
    (15, 1),
    (15, 14),
    (15, 2),
    ...
    (17, 7),
    (17, 6),
    -- Burberry Summer Men 2009
    (18, 9),
    (18, 7),
    (18, 14),
    (18, 6),
    (18, 13);
-- Burberry Summer Women 2009
